...
for i = 1:numel(algorithms)
    ...
    for j = 1:numel(datasets)     
        dataset      = datasets{j};
        predpath     = ['D:\wenzhang\code\EGA-Net\' alg '/None/' dataset '/'];
        maskpath     = ['D:\wenzhang\code\EGA-Net\data\RGBD_sal\test\' dataset '/mask/'];
        ...
        else names        = textread(['D:/DPANet-attetion/data/RGBD_sal/test/' dataset '/test.txt'], '%s'); end
